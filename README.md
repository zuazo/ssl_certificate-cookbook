...
[![Build Status](http://img.shields.io/travis/onddo/ssl_certificate-cookbook/1.2.2.svg?style=flat)](https://travis-ci.org/onddo/ssl_certificate-cookbook)
...
See the [`ServiceHelpers` class documentation](http://www.rubydoc.info/github/onddo/ssl_certificate-cookbook/1.2.2/Chef/SslCertificateCookbook/ServiceHelpers) to learn how to integrate them with new services.
